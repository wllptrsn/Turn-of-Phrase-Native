...
import GamePlay from "./Components/GameScreen"
...
function HomeStackScreen() {
  return (
    <HomeStack.Navigator hideNavBar= {true}>
      ...
      <HomeStack.Screen name="Game" component={GamePlay} options={{headerShown: false}}  />
    </HomeStack.Navigator>
  );
}
...
function SettingsStackScreen() {
  return (
    <SettingsStack.Navigator>
      ...
      <SettingsStack.Screen name="Details" component={GamePlay} />
    </SettingsStack.Navigator>
  );
}
